        ...
        <div class="nav_router">
            <el-dropdown trigger="click">
                ...
                <el-dropdown-item icon="el-icon-s-release" @click.native="golink3()">退出登录</el-dropdown-item> -->
                    <el-dropdown-item @click.native="golink()">我的收益</el-dropdown-item>
                    <el-dropdown-item @click.native="golink1()">西柚机管理</el-dropdown-item>
                    <el-dropdown-item @click.native="golink2()">个人中心</el-dropdown-item>
                    <el-dropdown-item @click.native="golink3()">退出登录</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
