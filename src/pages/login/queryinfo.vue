...
<div class="management">
    ...
    <div class="management_title_active">
        <el-row>
            <el-col :span="24">
                <div class="management_h1">西柚机管理</div>
            </el-col>
        </el-row>
    </div>
        ...
        <el-row>
            ...
            <el-col class="my_cols" style="margin-top: 30px;">
                <el-radio-group v-model="tabPosition" @change="queryInfo1">
                    <el-radio-button label="top">当日</el-radio-button>
                    <el-radio-button label="right">7日</el-radio-button>
                    <el-radio-button label="bottom">30天</el-radio-button>
                </el-radio-group>
                <div class="block" style="margin-left: 50px;">
                    <span class="demonstration">收益日期区间</span>
                ...
                <el-button type="primary" style="margin-left:50px;" @click="queryInfo2()">搜索</el-button>
            </el-col>
        </el-row>
            ...
            <el-col :span="24">
                <div>
                    <el-table :data="tableData" border style="width: 100%">
                        ...
                        <el-table-column prop="dev_sn" label="设备序列号">
                        </el-table-column>
                        <el-table-column prop="date_stamp" label="收益日期">
                        </el-table-column>
                        <el-table-column prop="dev_profit" label="当日收益">
                             <template slot-scope="scope">
                                <div class="item_myactive">{{scope.row.dev_profit}}</div>
                            </template>
                        </el-table-column>
                        <el-table-column prop="store_ability" label="当日存储力">
                        </el-table-column>
                        <el-table-column prop="user_space" label="当日使用空间">
                        </el-table-column>
                        <el-table-column prop="total_cap" label="总空间">
                        </el-table-column>
                        <el-table-column prop="up_bandwidth" label="当日上行带宽">
                        </el-table-column>
                        <el-table-column prop="online_time" label="当日在线时长">
                        </el-table-column>
