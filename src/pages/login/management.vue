            ...
            <el-col :span="24">
                <div>
                    <el-table :data="tableData" :highlight-current-row="true" border style="width: 100%" @row-click="openDetails">
                        ...
                        <el-table-column prop="dev_type" label="设备型号">
                        </el-table-column>
                        <el-table-column prop="dev_sn" label="设备序列号" width="300">
                        </el-table-column>
                        <el-table-column prop="dev_online_state" label="设备状态">
                        </el-table-column>
                        <el-table-column prop="dev_mac" label="MAC地址" width="200">
                        </el-table-column>
                        <el-table-column prop="dev_ip" label="内网IP">
                        </el-table-column>
